    ...
    Device(UIAC)
    {
        ...
        Name(RMCF, Package()
        {
            "8086_8c31", Package()
            {
                ...
                "ports", Package()
                {
                    "HS01", Package()    // HS component of USB 3.0 near righ
                    {
                        "UsbConnector", 3,
                        "port", Buffer() { 0x01, 0, 0, 0 },
                    },
                    "HS02", Package()    // HS component of USB 3.0 far right
                    {
                        "UsbConnector", 3,
                    ...
                    "SSP2", Package()    // USB 3.0 near right
                    {
                        "UsbConnector", 3,
                        "port", Buffer() { 0x11, 0, 0, 0 },
                    },
                    "SSP3", Package()    // USB 3.0 far right
                    {
                        "UsbConnector", 3,
